const DonteMain = () => {
    return (
        <div className="relative mt-10">
            ...
            {/* Content */}
            <div className="flex container gap-32 pl-40 mx-auto w-full py-28">
                <div className="left w-[40%]">
                    <h2 className="text-3xl"> HOW CAN YOU <span className="font-bold"> HELP? </span> </h2>
                    ...
                    <button className="mt-5 bg-[#DA5321] font px-6 py-2 text-white font-semibold"> DONATE NOW </button>
                </div>
                <div className="right">
